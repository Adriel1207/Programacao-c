...
int main(){
    //Declarar variaveis Produto, u i estoque, double valor unitario, double valor total e u i quantidade minima
    ...
    printf("Ovalor total de A (R$ %.2f) é maior que o valor total de B (R$ %.2f)? %d\n", estoqueA * valorA, estoqueB * valorB,
    (estoqueA * valorA) > (estoqueB * valorB));
